...
struct ContentView: View {
    ...
    @State private var editingItem: AdditiveUse?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Fuel Additive Log")
            .toolbar {
    ...
    private func editSheet(for item: AdditiveUse) -> some View {
...
struct EditItemView: View {
    ...
    @State var item: AdditiveUse
    var onSave: (AdditiveUse) -> Void
    var onDelete: () -> Void
